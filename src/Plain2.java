...
public class Plain2 implements IPlain  
{
	public void DrawPlain(Graphics g, Color color, int _startPosX, int _startPosY)
	{
			g.setColor(color);
			g.drawLine(_startPosX +5, _startPosY, _startPosX +5, _startPosY+4);
			...
			g.drawLine(_startPosX +5, _startPosY+4, _startPosX +3, _startPosY+5);
			g.drawLine(_startPosX +5, _startPosY+4, _startPosX +7, _startPosY+5);
	}
}
